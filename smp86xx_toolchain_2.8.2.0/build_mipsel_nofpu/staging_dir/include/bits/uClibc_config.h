...
#define __KERNEL_SOURCE__ "/opt/smp86xx/smp86xx_toolchain_2.8.2.0/toolchain_build_mipsel_nofpu/linux"
 ...
 */
#define __CROSS_COMPILER_PREFIX__ "/export/MIPStools/BR-T2C/buildroot/build_mipsel/staging_dir/bin/mipsel-linux-uclibc-"
#undef __DODEBUG__
