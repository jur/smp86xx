...
#define gt_ggc_m_14VEC_alias_pair(X) do { \
  if (X != NULL) gt_ggc_mx_VEC_alias_pair (X);\
  } while (0)
extern void gt_ggc_mx_VEC_alias_pair (void *);
#define gt_ggc_m_10alias_pair(X) do { \
  if (X != NULL) gt_ggc_mx_alias_pair (X);\
  } while (0)
extern void gt_ggc_mx_alias_pair (void *);
...
#define gt_ggc_m_8VEC_edge(X) do { \
  if (X != NULL) gt_ggc_mx_VEC_edge (X);\
  } while (0)
extern void gt_ggc_mx_VEC_edge (void *);
...
#define gt_ggc_m_8VEC_tree(X) do { \
  if (X != NULL) gt_ggc_mx_VEC_tree (X);\
  } while (0)
extern void gt_ggc_mx_VEC_tree (void *);
...
#define gt_pch_n_14VEC_alias_pair(X) do { \
  if (X != NULL) gt_pch_nx_VEC_alias_pair (X);\
  } while (0)
extern void gt_pch_nx_VEC_alias_pair (void *);
#define gt_pch_n_10alias_pair(X) do { \
  if (X != NULL) gt_pch_nx_alias_pair (X);\
  } while (0)
extern void gt_pch_nx_alias_pair (void *);
...
#define gt_pch_n_8VEC_edge(X) do { \
  if (X != NULL) gt_pch_nx_VEC_edge (X);\
  } while (0)
extern void gt_pch_nx_VEC_edge (void *);
...
#define gt_pch_n_8VEC_tree(X) do { \
  if (X != NULL) gt_pch_nx_VEC_tree (X);\
  } while (0)
extern void gt_pch_nx_VEC_tree (void *);
...
extern void gt_pch_p_15edge_prediction
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_14VEC_alias_pair
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_10alias_pair
    (void *, void *, gt_pointer_operator, void *);
...
extern void gt_pch_p_8bb_ann_d
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_8VEC_edge
    (void *, void *, gt_pointer_operator, void *);
...
extern void gt_pch_p_10tree_ann_d
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_8VEC_tree
    (void *, void *, gt_pointer_operator, void *);
