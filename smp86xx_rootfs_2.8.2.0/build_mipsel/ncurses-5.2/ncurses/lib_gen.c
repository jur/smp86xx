...
#undef attrset
int attrset ( attr_t z)
{
	T((T_CALLED("attrset(%s)"), _traceattr2(0,z))); returnCode( ((stdscr)->_attrs = (z)));
}
...
{
	T((T_CALLED("attr_get(%p,%p,%p)"), a1, a2, z)); returnCode( ((void)((a1) != 0 && (*(a1) = (stdscr)->_attrs)), (void)((a2) != 0 && (*(a2) = ((((stdscr)->_attrs) & ((((1UL) << 8) - 1UL) << ((0) + 8))) >> 8))), (0)));
}
...
int standout ( void)
{
	T((T_CALLED("standout()"))); returnCode( (((stdscr)->_attrs = (((1UL) << ((8) + 8))))));
}
...
int standend ( void)
{
	T((T_CALLED("standend()"))); returnCode( (((stdscr)->_attrs = (0L))));
}
...
#undef touchline
int touchline ( WINDOW * a1, int a2, int z)
{
...
{
	T((T_CALLED("wattrset(%p,%d)"), a1, z)); returnCode( ((a1)->_attrs = (z)));
}
...
{
	T((T_CALLED("wattr_get(%p,%p,%p,%p)"), a1, a2, a3, z)); returnCode( ((void)((a2) != 0 && (*(a2) = (a1)->_attrs)), (void)((a3) != 0 && (*(a3) = ((((a1)->_attrs) & ((((1UL) << 8) - 1UL) << ((0) + 8))) >> 8))), (0)));
}
...
{
	T((T_CALLED("wstandout(%p)"), z)); returnCode( (((z)->_attrs = (((1UL) << ((8) + 8))))));
}
...
{
	T((T_CALLED("wstandend(%p)"), z)); returnCode( (((z)->_attrs = (0L))));
}


#undef mouse_trafo
bool mouse_trafo ( int * a1, int * a2, bool z)
{
	T((T_CALLED("mouse_trafo(%p,%p,%#lx)"), a1, a2, (long)z)); returnCode( wmouse_trafo(stdscr,a1,a2,z));
}
